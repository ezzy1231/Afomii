...
import { createRestaurantListing, type DashboardActionState } from '@/app/dashboard/actions'
...
export default function RestaurantListingForm() {
  ...
  return (
    <section className="card-elevated p-6 sm:p-8">
      <h2 className="font-serif text-xl font-bold text-app-fg">Create restaurant listing</h2>
      <p className="mt-2 text-sm text-app-muted">Publish a live listing for the explore feed.</p>
      ...
      <form action={handleSubmit} className="mt-6 grid gap-5 sm:grid-cols-2">
        <label className="block text-sm font-medium text-app-fg">
          ...
          <input name="name" required className="input-premium" placeholder="Juniper Table" />
        </label>
        <label className="block text-sm font-medium text-app-fg">
          <span className="mb-1.5 block">Cuisine</span>
          <input name="cuisine" className="input-premium" placeholder="Modern African" />
        </label>
        <label className="block text-sm font-medium text-app-fg">
          <span className="mb-1.5 block">Area label</span>
          <input name="areaLabel" className="input-premium" placeholder="West End" />
        </label>
        <label className="block text-sm font-medium text-app-fg">
          <span className="mb-1.5 block">City</span>
          <input name="city" required className="input-premium" placeholder="Addis Ababa" />
        </label>
        <label className="block text-sm font-medium text-app-fg sm:col-span-2">
          <span className="mb-1.5 block">Closing label</span>
          <input name="closingLabel" className="input-premium" placeholder="Open until 11:00 PM" />
        </label>
